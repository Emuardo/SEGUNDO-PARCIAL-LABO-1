...
class Juego:
    def __init__(self):
        ...
        hoja_sprite_enemigo = HojaDeSprites(pygame.image.load(r"src\resources\sprites\mortifagos_sprite.png").convert_alpha(), 2, 4, ANCHO_JUGADOR, LARGO_JUGADOR, ["izquierda", "derecha"])
### INSTANCIO UN JUGADOR Y LE PASO EL GRUPO DONDE VA A PERTENECER
        
        self.jugador = Jugador([self.sprite_jugador], hoja_sprite_jugador)
        self.enemigo = Enemigo([self.enemigos], hoja_sprite_enemigo, 90, 1000 )
